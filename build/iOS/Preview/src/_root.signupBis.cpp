...
{
    signupBis::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 3, ::STRINGS[0/*"router"*/], ::STRINGS[1/*"temp_eb4"*/], ::STRINGS[2/*"temp_eb5"*/]);
    signupBis::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[3/*"Value"*/]);
}
...
static void signupBis_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("Pages/business/signupBis.ux");
    ...
    type->SetFields(126,
        ...
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(signupBis, temp_eb4), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(signupBis, temp_eb5), 0,
...
// public signupBis(Fuse.Navigation.Router router) :20
...
// public signupBis New(Fuse.Navigation.Router router) :20
...
// public signupBis(Fuse.Navigation.Router router) [instance] :20
...
void signupBis::InitializeUX()
{
    ...
    SourceLineNumber(1);
    SourceFileName(::STRINGS[9/*"Pages/busin...*/]);
    temp8->LineNumber(3);
    ...
    temp10->SourceFileName(::STRINGS[9/*"Pages/busin...*/]);
    ...
    temp->SourceFileName(::STRINGS[9/*"Pages/busin...*/]);
    ...
    temp4->SourceFileName(::STRINGS[9/*"Pages/busin...*/]);
    ...
    temp12->SourceFileName(::STRINGS[9/*"Pages/busin...*/]);
    ...
    temp1->SourceFileName(::STRINGS[9/*"Pages/busin...*/]);
    ...
    temp5->SourceFileName(::STRINGS[9/*"Pages/busin...*/]);
    ...
    temp14->SourceFileName(::STRINGS[9/*"Pages/busin...*/]);
    ...
    temp2->SourceFileName(::STRINGS[9/*"Pages/busin...*/]);
    ...
    temp6->SourceFileName(::STRINGS[9/*"Pages/busin...*/]);
    ...
    temp16->SourceFileName(::STRINGS[9/*"Pages/busin...*/]);
    ...
    temp17->SourceFileName(::STRINGS[9/*"Pages/busin...*/]);
    temp18->Color(::g::Uno::Float4__New2(0.3607843f, 0.6705883f, 0.9960784f, 1.0f));
    temp18->SourceLineNumber(24);
    temp18->SourceFileName(::STRINGS[9/*"Pages/busin...*/]);
    temp19->SourceLineNumber(25);
    temp19->SourceFileName(::STRINGS[9/*"Pages/busin...*/]);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp19->Bindings()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb5);
    temp20->SourceLineNumber(26);
    temp20->SourceFileName(::STRINGS[9/*"Pages/busin...*/]);
    temp20->add_Handler(uDelegate::New(::TYPES[5/*Fuse.VisualEventHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb5)));
    temp7->SourceLineNumber(26);
    temp7->SourceFileName(::STRINGS[9/*"Pages/busin...*/]);
...
// public signupBis New(Fuse.Navigation.Router router) [static] :20
