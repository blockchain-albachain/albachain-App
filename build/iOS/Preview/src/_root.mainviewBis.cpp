...
// {
// static mainviewBis() :9
static void mainviewBis__cctor_4_fn(uType* __type)
{
    mainviewBis::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 1, ::STRINGS[0/*"router"*/]);
}

static void mainviewBis_build(uType* type)
{
    ::STRINGS[0] = uString::Const("router");
    ::STRINGS[1] = uString::Const("Pages/business/mainviewBis.ux");
    ...
    type->SetFields(126,
        ...
        ::TYPES[0/*string[]*/], (uintptr_t)&mainviewBis::__g_static_nametable1_, uFieldFlagsStatic);
...
// public mainviewBis(Fuse.Navigation.Router router) :13
...
// public mainviewBis New(Fuse.Navigation.Router router) :13
...
// public mainviewBis(Fuse.Navigation.Router router) [instance] :13
...
void mainviewBis::InitializeUX()
{
    ...
    SourceLineNumber(1);
    SourceFileName(::STRINGS[1/*"Pages/busin...*/]);
    temp->LineNumber(3);
...
// public mainviewBis New(Fuse.Navigation.Router router) [static] :13
