...
// public partial sealed class MainView.Template2 :55
// {
// static Template2() :64
static void MainView__Template2__cctor__fn(uType* __type)
{
    MainView__Template2::__selector0_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[0/*"signupBis"*/]);
}

static void MainView__Template2_build(uType* type)
{
    ::STRINGS[0] = uString::Const("signupBis");
...
// public Template2(MainView parent, MainView parentInstance) :59
...
void MainView__Template2__New1_fn(MainView__Template2* __this, uObject** __retval)
{
    ...
    ::g::signupBis* __self1 = ::g::signupBis::New5(uPtr(__this->__parent1)->router);
...
// public Template2 New(MainView parent, MainView parentInstance) :59
...
// public Template2(MainView parent, MainView parentInstance) [instance] :59
...
// public Template2 New(MainView parent, MainView parentInstance) [static] :59
