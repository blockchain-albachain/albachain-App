...
static void StaticResources_build(uType* type)
{
    ...
    type->SetFields(120,
        ::g::Uno::Float4_typeof(), (uintptr_t)&StaticResources::BorderColor_, uFieldFlagsStatic,
    ...
    type->Reflection.SetFields(3,
        new uField("BaseFont", 121),
        new uField("BoldFont", 122),
        new uField("BorderColor", 120));
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)StaticResources__New4_fn, 0, true, type, 0));
}
...
::g::Fuse::Controls::Panel_type* StaticResources_typeof()
{
    ...
    type->fp_ctor_ = (void*)StaticResources__New4_fn;
...
// public StaticResources New() :17
void StaticResources__New4_fn(StaticResources** __retval)
{
    *__retval = StaticResources::New4();
}

::g::Uno::Float4 StaticResources::BorderColor_;
uSStrong< ::g::Fuse::Font*> StaticResources::BaseFont_;
uSStrong< ::g::Fuse::Font*> StaticResources::BoldFont_;

// public StaticResources() [instance] :17
void StaticResources::ctor_7()
{
    ctor_6();
    InitializeUX();
}
...
StaticResources* StaticResources::New4()
{
    StaticResources* obj1 = (StaticResources*)uNew(StaticResources_typeof());
    obj1->ctor_7();
    return obj1;
}
// }
