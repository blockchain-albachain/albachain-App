// This file was generated based on /Users/kbs/development/albachain/build/iOS/Preview/cache/ux15/BoldText.g.uno.
...
// {
// static BoldText() :4
static void BoldText__cctor_5_fn(uType* __type)
{
}
...
static void BoldText_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)BoldText__New5_fn, 0, true, type, 0));
}
...
::g::Fuse::Controls::TextControl_type* BoldText_typeof()
{
    ...
    options.BaseDefinition = ::g::BaseText_typeof();
    options.FieldCount = 121;
    options.InterfaceCount = 19;
    options.DependencyCount = 1;
    options.ObjectSize = sizeof(BoldText);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("BoldText", options);
    type->fp_build_ = BoldText_build;
    type->fp_ctor_ = (void*)BoldText__New5_fn;
    type->fp_cctor_ = BoldText__cctor_5_fn;
...
// public BoldText New() :8
void BoldText__New5_fn(BoldText** __retval)
{
    *__retval = BoldText::New5();
}

// public BoldText() [instance] :8
void BoldText::ctor_9()
{
    ctor_8();
    InitializeUX2();
}
...
// public BoldText New() [static] :8
BoldText* BoldText::New5()
{
    BoldText* obj1 = (BoldText*)uNew(BoldText_typeof());
    obj1->ctor_9();
    return obj1;
}
// }
