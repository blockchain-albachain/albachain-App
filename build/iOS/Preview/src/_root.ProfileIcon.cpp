// This file was generated based on /Users/kbs/development/albachain-App/build/iOS/Preview/cache/ux15/ProfileIcon.g.uno.
...
// {
// static ProfileIcon() :4
static void ProfileIcon__cctor_5_fn(uType* __type)
{
}

static void ProfileIcon_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)ProfileIcon__New5_fn, 0, true, type, 0));
}

::g::Fuse::Controls::Image_type* ProfileIcon_typeof()
{
    ...
    options.ObjectSize = sizeof(ProfileIcon);
    options.TypeSize = sizeof(::g::Fuse::Controls::Image_type);
    type = (::g::Fuse::Controls::Image_type*)uClassType::New("ProfileIcon", options);
    type->fp_build_ = ProfileIcon_build;
    type->fp_ctor_ = (void*)ProfileIcon__New5_fn;
    type->fp_cctor_ = ProfileIcon__cctor_5_fn;
...
// public ProfileIcon() :8
void ProfileIcon__ctor_8_fn(ProfileIcon* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void ProfileIcon__InitializeUX1_fn(ProfileIcon* __this)
{
    __this->InitializeUX1();
}

// public ProfileIcon New() :8
void ProfileIcon__New5_fn(ProfileIcon** __retval)
{
    *__retval = ProfileIcon::New5();
}

// public ProfileIcon() [instance] :8
void ProfileIcon::ctor_8()
{
    uStackFrame __("ProfileIcon", ".ctor()");
    ctor_7();
    InitializeUX1();
}

// private void InitializeUX() [instance] :12
void ProfileIcon::InitializeUX1()
{
    uStackFrame __("ProfileIcon", "InitializeUX()");
    ...
    temp1->Density(1.0f);
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::albachain_bundle::profile1xaa2b8d04()));
    temp2->Density(2.0f);
    temp2->File(::g::Uno::UX::BundleFileSource::New1(::g::albachain_bundle::profile2xaa2b8901()));
    temp3->Density(4.0f);
    temp3->File(::g::Uno::UX::BundleFileSource::New1(::g::albachain_bundle::profile4xaa2ba107()));
    Source(temp);
}

// public ProfileIcon New() [static] :8
ProfileIcon* ProfileIcon::New5()
{
    ProfileIcon* obj1 = (ProfileIcon*)uNew(ProfileIcon_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
