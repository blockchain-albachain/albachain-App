...
{
    ::STRINGS[0] = uString::Const("Pages/individual/profile.ux");
    ::STRINGS[1] = uString::Const("profile");
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)profile__New5_fn, 0, true, type, 0));
}
...
// public profile New() :8
void profile__New5_fn(profile** __retval)
{
    *__retval = profile::New5();
}

// public profile() [instance] :8
void profile::ctor_8()
{
    uStackFrame __("profile", ".ctor()");
    ctor_7();
    InitializeUX();
}
...
// public profile New() [static] :8
profile* profile::New5()
{
