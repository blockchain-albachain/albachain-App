...
// public partial sealed class HomeIcon :2
// {
// static HomeIcon() :4
static void HomeIcon__cctor_5_fn(uType* __type)
{
}

static void HomeIcon_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)HomeIcon__New5_fn, 0, true, type, 0));
}

::g::Fuse::Controls::Image_type* HomeIcon_typeof()
{
    ...
    options.ObjectSize = sizeof(HomeIcon);
    options.TypeSize = sizeof(::g::Fuse::Controls::Image_type);
    type = (::g::Fuse::Controls::Image_type*)uClassType::New("HomeIcon", options);
    type->fp_build_ = HomeIcon_build;
    type->fp_ctor_ = (void*)HomeIcon__New5_fn;
    type->fp_cctor_ = HomeIcon__cctor_5_fn;
...
// public HomeIcon() :8
void HomeIcon__ctor_8_fn(HomeIcon* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void HomeIcon__InitializeUX1_fn(HomeIcon* __this)
{
    __this->InitializeUX1();
}

// public HomeIcon New() :8
void HomeIcon__New5_fn(HomeIcon** __retval)
{
    *__retval = HomeIcon::New5();
}

// public HomeIcon() [instance] :8
void HomeIcon::ctor_8()
{
    uStackFrame __("HomeIcon", ".ctor()");
    ctor_7();
    InitializeUX1();
}

// private void InitializeUX() [instance] :12
void HomeIcon::InitializeUX1()
{
    uStackFrame __("HomeIcon", "InitializeUX()");
...
// public HomeIcon New() [static] :8
HomeIcon* HomeIcon::New5()
{
    HomeIcon* obj1 = (HomeIcon*)uNew(HomeIcon_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
