...
// public partial sealed class GoalsIcon :2
// {
// static GoalsIcon() :4
static void GoalsIcon__cctor_5_fn(uType* __type)
{
}

static void GoalsIcon_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)GoalsIcon__New5_fn, 0, true, type, 0));
}

::g::Fuse::Controls::Image_type* GoalsIcon_typeof()
{
    ...
    options.ObjectSize = sizeof(GoalsIcon);
    options.TypeSize = sizeof(::g::Fuse::Controls::Image_type);
    type = (::g::Fuse::Controls::Image_type*)uClassType::New("GoalsIcon", options);
    type->fp_build_ = GoalsIcon_build;
    type->fp_ctor_ = (void*)GoalsIcon__New5_fn;
    type->fp_cctor_ = GoalsIcon__cctor_5_fn;
...
// public GoalsIcon() :8
void GoalsIcon__ctor_8_fn(GoalsIcon* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void GoalsIcon__InitializeUX1_fn(GoalsIcon* __this)
{
    __this->InitializeUX1();
}

// public GoalsIcon New() :8
void GoalsIcon__New5_fn(GoalsIcon** __retval)
{
    *__retval = GoalsIcon::New5();
}

// public GoalsIcon() [instance] :8
void GoalsIcon::ctor_8()
{
    uStackFrame __("GoalsIcon", ".ctor()");
    ctor_7();
    InitializeUX1();
}

// private void InitializeUX() [instance] :12
void GoalsIcon::InitializeUX1()
{
    uStackFrame __("GoalsIcon", "InitializeUX()");
...
// public GoalsIcon New() [static] :8
GoalsIcon* GoalsIcon::New5()
{
    GoalsIcon* obj1 = (GoalsIcon*)uNew(GoalsIcon_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
