// This file was generated based on /Users/kbs/development/albachain/build/iOS/Preview/cache/ux15/BaseText.g.uno.
...
// {
// static BaseText() :4
static void BaseText__cctor_4_fn(uType* __type)
{
}
...
static void BaseText_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)BaseText__New4_fn, 0, true, type, 0));
}
...
::g::Fuse::Controls::TextControl_type* BaseText_typeof()
{
    ...
    options.ObjectSize = sizeof(BaseText);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("BaseText", options);
    type->fp_build_ = BaseText_build;
    type->fp_ctor_ = (void*)BaseText__New4_fn;
    type->fp_cctor_ = BaseText__cctor_4_fn;
...
// public BaseText New() :8
void BaseText__New4_fn(BaseText** __retval)
{
    *__retval = BaseText::New4();
}

// public BaseText() [instance] :8
void BaseText::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
void BaseText::InitializeUX1()
{
    uStackFrame __("BaseText", "InitializeUX()");
    FontSize(14.0f);
...
// public BaseText New() [static] :8
BaseText* BaseText::New4()
{
    BaseText* obj1 = (BaseText*)uNew(BaseText_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
