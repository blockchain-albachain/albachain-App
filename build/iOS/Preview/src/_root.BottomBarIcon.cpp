...
// public partial class BottomBarIcon :2
// {
// static BottomBarIcon() :4
static void BottomBarIcon__cctor_4_fn(uType* __type)
{
}

static void BottomBarIcon_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)BottomBarIcon__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::Image_type* BottomBarIcon_typeof()
{
    ...
    options.ObjectSize = sizeof(BottomBarIcon);
    options.TypeSize = sizeof(::g::Fuse::Controls::Image_type);
    type = (::g::Fuse::Controls::Image_type*)uClassType::New("BottomBarIcon", options);
    type->fp_build_ = BottomBarIcon_build;
    type->fp_ctor_ = (void*)BottomBarIcon__New4_fn;
    type->fp_cctor_ = BottomBarIcon__cctor_4_fn;
...
// public BottomBarIcon() :8
void BottomBarIcon__ctor_7_fn(BottomBarIcon* __this)
{
    __this->ctor_7();
}

// private void InitializeUX() :12
void BottomBarIcon__InitializeUX_fn(BottomBarIcon* __this)
{
    __this->InitializeUX();
}

// public BottomBarIcon New() :8
void BottomBarIcon__New4_fn(BottomBarIcon** __retval)
{
    *__retval = BottomBarIcon::New4();
}

// public BottomBarIcon() [instance] :8
void BottomBarIcon::ctor_7()
{
    ctor_6();
    InitializeUX();
}
...
void BottomBarIcon::InitializeUX()
{
    uStackFrame __("BottomBarIcon", "InitializeUX()");
    StretchMode(1);
    SourceLineNumber(10);
    SourceFileName(::STRINGS[0/*"StsticResou...*/]);
}

// public BottomBarIcon New() [static] :8
BottomBarIcon* BottomBarIcon::New4()
{
    BottomBarIcon* obj1 = (BottomBarIcon*)uNew(BottomBarIcon_typeof());
    obj1->ctor_7();
    return obj1;
}
// }
