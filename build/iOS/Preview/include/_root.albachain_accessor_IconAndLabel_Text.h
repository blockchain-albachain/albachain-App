...
namespace g{struct albachain_accessor_IconAndLabel_Text;}
...
struct albachain_accessor_IconAndLabel_Text : ::g::Uno::UX::PropertyAccessor
{
    static uSStrong< ::g::Uno::UX::PropertyAccessor*> Singleton_;
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return albachain_accessor_IconAndLabel_Text_typeof()->Init(), Singleton_; }
    static ::g::Uno::UX::Selector _name_;
    static ::g::Uno::UX::Selector& _name() { return albachain_accessor_IconAndLabel_Text_typeof()->Init(), _name_; }

    void ctor_1();
    static albachain_accessor_IconAndLabel_Text* New1();
};
// }
